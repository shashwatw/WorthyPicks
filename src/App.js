...
export default function App() {
  ...
  //Return stored values in localstorage
...
function Search({ query, setQuery }) {
  ...
  useEffect(
    function () {
      function callback(e) {
        //while you are in search elemnt and want to search...after enter key it won't erase data
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  //amount of clicks it take to finally rate movie
  ...
  function handleAdd() {
    ...
    //to eradicate stale state we passed callback function
  ...
  useEffect(
    ...
    //effect will be rendered everytime selectedId changes
    [selectedId]
  );
